...
\begin{figure}[htbp]
    ...
    \bicaption{自研 10$\times$/0.4 NA 空气物镜的 Zemax 光学仿真}{Zemax optical simulation of a self-designed 10$\times$/0.4 NA air objective}
    \label{fig09}
\end{figure}
除商业物镜选型外，本文还尝试在空气物镜基础上设计一套 10$\times$/0.4 NA 物镜，用于分析较高数值孔径与较大扫描视场条件下的光学设计可行性。该设计在 Zemax 中完成优化，并将原始玻璃材料替换为 CDGM 玻璃，以提高后续加工实现的可行性。图~\ref{fig09} 给出了该物镜的光学设计结果，包括A: 结构布局、B: modulation transfer function (MTF) 曲线以及C: 像差分析结果。结果表明，该设计在目标视场范围内具有较好的成像性能，可为后续扫描显微系统中的物镜设计提供参考。
>>>>>>> c4bb8a8e4d07c80bffd10fe9aeb672bafe56fbee
